...
I will introduce procedure of 2018 DPStoPsi2SJ here
...
cd Instruction/DPStoPsi2SJ/GENSIM-2018
ls

our step 2
#run locally first to check

cmsRun BPH_DPStoPsi2SJ_2018.py
...
crab submit -c crab_BPH_DPStoPsi2SJ_2018.py

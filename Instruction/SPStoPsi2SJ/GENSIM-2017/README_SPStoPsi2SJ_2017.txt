...
I will introduce procedure of 2017 SPStoPsi2SJ here
...
cd Instruction/SPStoPsi2SJ/GENSIM-2017
ls

our step 2
#run locally first to check

cmsRun BPH_SPStoPsi2SJ_2017.py
...
crab submit -c crab_BPH_SPStoPsi2SJ_2017.py

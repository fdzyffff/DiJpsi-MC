...
I will introduce procedure of 2018 SPStoPsi2SJ here
...
cd Instruction/SPStoPsi2SJ/GENSIM-2018
ls

our step 2
#run locally first to check

cmsRun BPH_SPStoPsi2SJ_2018.py
...
crab submit -c crab_BPH_SPStoPsi2SJ_2018.py

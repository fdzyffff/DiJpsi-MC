...
I will introduce procedure of 2016 SPStoPsi2SJ here
...
cd Instruction/SPStoPsi2SJ/GENSIM-2016
ls

our step 2
#run locally first to check

cmsRun BPH_SPStoPsi2SJ_2016.py
...
crab submit -c crab_BPH_SPStoPsi2SJ_2016.py

...
I will introduce procedure of 2016 BBartoJJ here
...
cd Instruction/BBartoJJ/GENSIM-2016
ls

our step 2
#run locally first to check
#if run locally, replace the input file str '../myBBartoJpsi.dec' with 'myBBartoJpsi.dec' 
cmsRun BPH_BBartoJJ_2016.py
...
crab submit -c crab_BPH_BBartoJJ_2016.py

our step 3
follow Zhen's instruction to go rest steps, the DIGI-RAW and RECO
NOTE that you should do rest steps at CMSSW_8_0_31!
